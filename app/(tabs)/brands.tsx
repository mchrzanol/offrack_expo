  ...
  return (
    ...
    >
        ...
        {brands.map((brand, index) => (
          <Pressable onPress={() =>navigation.navigate('brandView', { brand_id: brand.id, brand_name: brand.name })} key={index}>
            <View
                key={index}
            ...
            {brand.logo_url ? (
              ...
              <Text className="text-black text-2xl ml-1">{brand.name}</Text>
            )}
